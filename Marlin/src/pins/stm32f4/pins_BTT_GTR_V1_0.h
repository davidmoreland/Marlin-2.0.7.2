...
// Limit Switches
//
#define X_MIN_PIN                           PF2  //X-Front
#define X_MAX_PIN                           PG14  //X-Rear
#define Y_MIN_PIN                           PC13  //Y-Laser
#define Y_MAX_PIN                           PG9   // Z2 - Back
#define Z_MIN_PIN                           PE0   // Z1 - Left Side
#define Z_MAX_PIN                           PD3    // Z3 - Right Side
